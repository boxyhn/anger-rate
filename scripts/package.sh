...
DMG_PATH="$DIST_DIR/AngerRate-0.1.2.dmg"
...
/usr/bin/ditto "$PROJECT_DIR/THIRD_PARTY_NOTICES.md" "$CONTENTS/Resources/THIRD_PARTY_NOTICES.md"
/usr/bin/ditto "$PROJECT_DIR/ThirdPartyLicenses" "$CONTENTS/Resources/ThirdPartyLicenses"
/usr/bin/ditto "$PROJECT_DIR/assets/AppIcon.icns" "$CONTENTS/Resources/AppIcon.icns"
